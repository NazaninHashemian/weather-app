  ...
  return (
    <>
        <div className="extra-info-card">           
              <p>Feels Like: {onGetTemperature(weatherData.current.feelslike_c, unitSymbols)}°{unitSymbols}</p>
              <p>Max Temp: {onGetTemperature(weatherData.forecast.forecastday[0].day.maxtemp_c, unitSymbols)}°{unitSymbols}</p>
              <p>Min Temp: {onGetTemperature(weatherData.forecast.forecastday[0].day.mintemp_c, unitSymbols)}°{unitSymbols}</p>
