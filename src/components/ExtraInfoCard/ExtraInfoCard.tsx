  ...
  return (
    <>
        <div className="extra-info-card">           
              <p>Feels Like: {onGetTemperature(weatherData.current.feelslike_c)}°{unitSymbols.unit}</p>
              <p>Max Temp: {onGetTemperature(weatherData.forecast.forecastday[0].day.maxtemp_c)}°{unitSymbols.unit}</p>
              <p>Min Temp: {onGetTemperature(weatherData.forecast.forecastday[0].day.mintemp_c)}°{unitSymbols.unit}</p>
